...
class BuildkitePublisherBase(wtforms.Form):
    ...
    @property
    def normalized_build_branch(self) -> str | None:
        return self.build_branch.data or None

    @property
    def normalized_build_tag(self) -> str | None:
        return self.build_tag.data or None

    @property
    def normalized_step_key(self) -> str | None:
        return self.step_key.data or None
