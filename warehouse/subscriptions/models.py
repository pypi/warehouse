...
class StripeSubscription(db.Model):
    ...
    __table_args__ = (
        Index("stripe_subscriptions_customer_id_idx", "customer_id"),
    ...
    customer_id = Column(
        ForeignKey("organization_stripe_customers.customer_id", onupdate="CASCADE"),
        nullable=False,
    ...
    subscription_items = orm.relationship(
        "StripeSubscriptionItem", back_populates="subscription", lazy=False
    )
