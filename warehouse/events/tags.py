...
class EventTag:
    ...
    class Project(EventTagEnum):
        ...
        ProjectSizeLimitRequestApproved = "admin:project:size_limit_request:approved"
        ProjectSizeLimitRequestDeclined = "admin:project:size_limit_request:declined"
        ProjectSizeLimitRequestSubmitted = "project:size_limit_request:submitted"
