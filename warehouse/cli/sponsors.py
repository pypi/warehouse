...
SPONSORS_DICTS = [
    ...
    dict(
      ...
      image="facebook.png",
      activity=[
        "Facebook / Instagram is a sustainability sponsor of the Python Software Foundation."
      ],
      footer=True,
      psf_sponsor=True,
      infra_sponsor=False,
    ...
    dict(
      ...
      image="cockroach.png",
      activity=[
        "Cockroach Labs is a contributing sponsor of the Python Software Foundation."
      ],
      footer=False,
      psf_sponsor=True,
      infra_sponsor=False,
    ...
    dict(
      ...
      image="openEDG.png",
      activity=[
        "OpenEDG Python Institute is a supporting sponsor of the Python Software Foundation."
      ],
      footer=False,
      psf_sponsor=True,
      infra_sponsor=False,
    ...
    dict(
      ...
      activity=[
        "Mattermost is a partner sponsor of the Python Software Foundation."
      ],
      footer=False,
      psf_sponsor=True,
      infra_sponsor=False,
    ...
    dict(
      ...
      image="tidelift.png",
      activity=[
        "Tidelift is a partner sponsor of the Python Software Foundation."
      ],
      footer=False,
      psf_sponsor=True,
      infra_sponsor=False,
    ...
    dict(
      ...
      image="saleor.png",
      activity=[
        "Saleor is a partner sponsor of the Python Software Foundation."
      ],
      footer=False,
      psf_sponsor=True,
      infra_sponsor=False,
    ...
    dict(
      ...
      activity=[
        "Cuttlesoft is a partner sponsor of the Python Software Foundation."
      ],
      footer=False,
      psf_sponsor=True,
      infra_sponsor=False,
    ...
    dict(
      ...
      image="tara.png",
      activity=[
        "Tara AI is a partner sponsor of the Python Software Foundation."
      ],
      footer=False,
      psf_sponsor=True,
      infra_sponsor=False,
    ...
    dict(
      ...
      image="elastic.png",
      activity=[
        "Elasticsearch, Inc. is a partner sponsor of the Python Software Foundation."
      ],
      footer=False,
      psf_sponsor=True,
      infra_sponsor=False,
    ...
    dict(
      ...
      image="netflix.png",
      activity=[
        "Netflix is a partner sponsor of the Python Software Foundation."
      ],
      footer=False,
      psf_sponsor=True,
      infra_sponsor=False,
    ...
    dict(
      ...
      image="scout.png",
      activity=[
        "Scout APM is a partner sponsor of the Python Software Foundation."
      ],
      footer=False,
      psf_sponsor=True,
      infra_sponsor=False,
    ...
    dict(
      ...
      image="adimian.png",
      activity=[
        "Adimian.be SPRL is a participating sponsor of the Python Software Foundation."
      ],
      footer=False,
      psf_sponsor=True,
      infra_sponsor=False,
    ...
    dict(
      ...
      activity=[
        "Python Academy is a participating sponsor of the Python Software Foundation."
      ],
      footer=False,
      psf_sponsor=True,
      infra_sponsor=False,
    ...
    dict(
      ...
      image="pingdom.png",
      activity=[
        "PyPI's infrastructure volunteers use Pingdom to monitor and receive alerts about downtime and other issues affecting end-users."
      ],
      footer=False,
      psf_sponsor=False,
      infra_sponsor=True,
    ...
    dict(
      ...
      image="sentry.png",
      activity=[
        "The PyPI team uses Sentry to capture, record, and respond to exceptions and errors on PyPI."
      ],
      footer=False,
      psf_sponsor=False,
      infra_sponsor=True,
    ...
    dict(
      ...
      image="aws.png",
      activity=[
        "PyPI uses AWS infrastructure to host the machines that power our services, serve DNS, host our databases, and send and monitor email.",
      ],
      footer=False,
      psf_sponsor=False,
      infra_sponsor=True,
    ...
    dict(
      ...
      image="fastly.png",
      activity=[
        "PyPI uses Fastly's CDN to quickly serve content to end-users, allowing us to minimize our hosting infrastructure and obscure possible downtime."
      ],
      footer=False,
      psf_sponsor=False,
      infra_sponsor=True,
    ...
    dict(
      ...
      image="digicert.png",
      activity=[
        "PyPI uses Digicert to secure communication and prove identity with an EV Certificate."
      ],
      footer=False,
      psf_sponsor=False,
      infra_sponsor=True,
