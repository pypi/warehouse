...
def upgrade():
    ...
    op.create_index("two_factor_user_id", "two_factor", ["user_id"], unique=False)
...
def downgrade():
    ...
    op.add_column(
        "users",
        sa.Column(
            "totp_secret", postgresql.BYTEA(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "users",
    ...
    op.drop_index("two_factor_user_id", table_name="two_factor")
