...
Revision ID: 93c57e18f959
Revises: None
Create Date: 2025-02-11 15:21:23.395404
"""
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "sitemap_bucket", sa.String(), server_default=FetchedValue(), nullable=True
        ),
        sa.Column(
            "id", sa.UUID(), server_default=sa.text("gen_random_uuid()"), nullable=False
        ),
    ...
    # op.alter_column("projects", "sitemap_bucket", nullable=False)
    ...
    # op.alter_column("users", "sitemap_bucket", nullable=True)
