...
def upgrade():
    op.create_table(
        ...
        sa.Column("vcs_origin", sa.String(), nullable=False),
        sa.Column("circleci_org_name", sa.String(), nullable=True),
        sa.Column("circleci_project_name", sa.String(), nullable=True),
