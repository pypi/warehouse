...
class OrganizationStripeCustomer(db.Model):
    ...
    __table_args__ = (
        ...
        Index("organization_stripe_customers_customer_id_idx", "customer_id"),
        UniqueConstraint(
            "organization_id",
            "customer_id",
    ...
    __repr__ = make_repr("organization_id", "customer_id")
...
class Organization(HasEvents, db.Model):
    ...
    def stripe_customer_id(self):
        try:
            ...
            return organization_stripe_customer.customer_id
        except NoResultFound:
            return None
