...
You can [file an issue on our tracker](https://github.com/pypi/support/issues) to request assistance with account recovery.

**Note:** By their nature, account recovery issues are labor intensive. The PyPI team has limited resources available for their completion. There may be a delay of a week or more between responses for these issues.
