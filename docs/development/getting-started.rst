...
- For real-time chat with other PyPA developers, join ``#pypa-dev`` `on
  Freenode`_;
- For longer-form questions or discussion, message the `pypa-dev mailing list <https://mail.python.org/mailman3/lists/distutils-sig.python.org/>`_.
...
Freenode`_, or the `pypa-dev mailing list <https://mail.python.org/mailman3/lists/distutils-sig.python.org/>`_, to ask questions or get
...
.. _`pypa-dev mailing list`: https://mail.python.org/mailman3/lists/distutils-sig.python.org/
