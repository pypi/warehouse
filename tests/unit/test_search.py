...
class TestQueries:
    ...
    def test_quoted_query(self, terms, expected_prefix, expected_type):
        ...
        query = queries.get_os_query(os, terms, "", [])
    ...
    def test_sort_order(self, order, field):
        ...
        query = queries.get_os_query(os, terms, order, [])
    ...
    def test_with_classifiers_with_terms(self):
        ...
        query = queries.get_os_query(os, terms, "", classifiers)
    ...
    def test_with_classifier_with_no_terms_and_order(self):
        ...
        query = queries.get_os_query(os, terms, "-created", classifiers)
