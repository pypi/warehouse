...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            None,
            None,
            {"test.foo": "redis://192.0.2.1:6379/0"},
        ),
        (
            {"REDIS_URL": "redis://192.0.2.1:6379"},
            None,
        ...
        (
            ...
            None,
            1,
            {"test.foo": "redis://192.0.2.1:6379/1"},
        ),
        ({}, None, None, None, {}),
        ({}, None, None, 0, {}),
        ({}, None, None, 1, {}),
        ...
        (
            {},
            str,
            "redis://192.0.2.1:6379/6",
            1,
            {"test.foo": "redis://192.0.2.1:6379/6"},
        ),
        (
            {"REDIS_URL": "redis://192.0.2.1:6379/6"},
            str,
            None,
            9,
            {"test.foo": "redis://192.0.2.1:6379/9"},
        ),
        (
