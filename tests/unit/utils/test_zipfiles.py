...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("reject/eocd64_non_locator.zip", "Corrupt zip64 end of central directory record"),
        ("reject/eocd64_without_eocd.zip", "Corrupt zip64 end of central directory record"),
