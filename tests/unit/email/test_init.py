...
class TestSendOrganizationSurveyEmail:
    def test_send_organization_survey_email(
        self, db_request, pyramid_config, monkeypatch
    ):
        user = UserFactory.create(with_verified_primary_email=True)
        ...
        subject_renderer = pyramid_config.testing_add_renderer(
            "email/organization-survey/subject.txt"
        )
        subject_renderer.string_response = "Email Subject"
        body_renderer = pyramid_config.testing_add_renderer(
            "email/organization-survey/body.txt"
        )
        body_renderer.string_response = "Email Body"
        html_renderer = pyramid_config.testing_add_renderer(
            "email/organization-survey/body.html"
        )
        html_renderer.string_response = "Email HTML Body"
        ...
        result = email.send_organization_survey_email(
            db_request,
            user,
            organization_name=organization_name,
