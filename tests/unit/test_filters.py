...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Release Notes", "https://example.com", "fas fa-newspaper"),
        ("Security", "https://example.com", "fas fa-shield"),
        ("Source", "https://example.com", "fas fa-code-branch"),
        ("Project", "https://t.me/example", "fab fa-telegram"),
        ("Project", "https://matrix.to/#/example", "fab fa-matrix"),
