...
def pyramid_services(
    ...
    services.register_service(email_domain_check_service, IEmailDomainCheckService)
...
@pytest.fixture
def email_domain_check_service(mocker):
    service = account_services.NullEmailDomainCheckService()
    mocker.spy(service, "check_domain")
    return service
