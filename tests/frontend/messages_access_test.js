...
import {
  ...
  ngettext,
  ngettextCustom,
} from "../../warehouse/static/js/warehouse/utils/messages-access";
...
describe("messages access util", () => {
  describe("gettext with defaults", () => {
    ...
    ])("translates $singular $extras to '$expected'", async ({ singular, extras, expected }) => {
  ...
  describe("ngettext with defaults", () => {
    it.each([
      ...
      "translates $singular $plural $num $extras to '$expected'",
      async ({ singular, plural, num, extras, expected }) => {
  ...
  describe("with data 'en' having more than one plural form", () => {
    ...
    // messages-access.js by rspack.plugin.localize.js.
    const data = {
      ...
      "My message with plurals %1 again": [
        "My translated message 1 %1.",
        "My translated message 2 %1.",
      ],
    };
    ...
    // generated by rspack.plugin.localize.js and this test must match a generated function.
