...
<p id="shown-and-total">Showing <span id="shown" data-filter-list-target="shown"></span> of <span id="total" data-filter-list-target="total"></span> files.</p>
`;
  ...
  describe("is initialized as expected", () => {
    ...
    describe("displays count of visible items", () => {
      ...
      it("all items begin shown", () => {
        ...
        expect(elTotal).toHaveTextContent("3");

        const elShown = document.getElementById("shown");
        expect(elShown).toHaveTextContent("3");
      });
    });
  });
